...
export const Cart = () => {
  ...
  const [userType, setUserType] = useState(null); // Supongamos que obtienes el userType de alguna manera
      ...
      <div className="flex flex-col justify-center items-center flex-grow">
        ...
        >
          <div className="flex flex-col items-center justify-center text-center p-8 bg-white bg-opacity-70 rounded-lg max-w-lg mx-auto md:max-w-2xl w-full">
            ...
            {/* Mostrar el botón de Mercado Pago o el botón de inicio de sesión basado en el userType */}
            {carrito.length > 0 && (
              <>
                {userType === 'comprador' ? (
                  preferenceId ? (
