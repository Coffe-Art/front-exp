...
export const CreateProduct = () => {
  ...
  useEffect(() => {
    const fetchCategorias = () => {
      const categorias = [
        // Aquí puedes agregar tus categorías como antes
      ];
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              onChange={handleChange}
            />
             <p className="text-gray-600 text-sm mt-1">Separa los materiales por comas :)</p>
          </div>
          <div className="mb-4">
            ...
            />
            <p className="text-gray-600 text-sm mt-1">Tipos de imágenes permitidos: JPEG, PNG.</p>
          </div>
          <button
            type="submit"
            className=" text-white bg-darkyellow hover:bg-lightyellow font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
          >
            Crear Producto
          </button>
        </form>
